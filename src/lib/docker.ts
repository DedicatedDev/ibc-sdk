...
export const images = {
  ...
  ethRelayer: new DockerImage('ghcr.io/polymerdao/eth-relayer', 'v0.0.1-rc7', 'ETH_RELAYER_DOCKER_IMAGE_TAG'),
  ...
  polymer: new DockerImage('ghcr.io/polymerdao/polymer', 'v0.0.1-rc7-2', 'POLYMER_DOCKER_IMAGE_TAG'),
  ...
  vibcRelayer: new DockerImage('ghcr.io/polymerdao/vibc-relayer', 'v0.0.1-rc11', 'VIBC_RELAYER_DOCKER_IMAGE_TAG'),
