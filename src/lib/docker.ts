...
export const images = {
  ...
  ethRelayer: new DockerImage('ghcr.io/polymerdao/eth-relayer', 'v0.0.1-rc10', 'ETH_RELAYER_DOCKER_IMAGE_TAG'),
  ...
  vibcRelayer: new DockerImage('ghcr.io/polymerdao/vibc-relayer', 'v0.0.1-rc15', 'VIBC_RELAYER_DOCKER_IMAGE_TAG'),
