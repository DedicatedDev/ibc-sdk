...
export const protobufPackage = "polyibc.lightclients.ethclique";
...
/**
 * Header defines the ethclique client consensus Header. It encapsulates all the
 * information necessary to update from a trusted ethclique ConsensusState.
 */
...
function createBaseConsensusState(): ConsensusState {
  return { ethHeader: new Uint8Array() };
}

export const ConsensusState = {
  encode(message: ConsensusState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.ethHeader.length !== 0) {
      writer.uint32(10).bytes(message.ethHeader);
    }
    return writer;
  },
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ConsensusState {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.ethHeader = reader.bytes();
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): ConsensusState {
    return { ethHeader: isSet(object.ethHeader) ? bytesFromBase64(object.ethHeader) : new Uint8Array() };
  },

  toJSON(message: ConsensusState): unknown {
    const obj: any = {};
    message.ethHeader !== undefined &&
      (obj.ethHeader = base64FromBytes(message.ethHeader !== undefined ? message.ethHeader : new Uint8Array()));
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<ConsensusState>, I>>(object: I): ConsensusState {
    const message = createBaseConsensusState();
    message.ethHeader = object.ethHeader ?? new Uint8Array();
    return message;
  },
};

function createBaseHeader(): Header {
  return { ethHeader: new Uint8Array(), trustedHeight: undefined };
}
...
export const Header = {
  ...
  fromJSON(object: any): Header {
    return {
      ethHeader: isSet(object.ethHeader) ? bytesFromBase64(object.ethHeader) : new Uint8Array(),
