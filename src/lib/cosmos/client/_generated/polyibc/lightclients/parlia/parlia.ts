...
export const protobufPackage = "polyibc.lightclients.parlia";

/** ClientState from parlia PoS on Binance Smart Chain */
...
/** ConsensusState defines the consensus state from parlia. */
export interface ConsensusState {
  /** opaque json bytes which must be unmarshalled into a list of valid headers */
  headers: Uint8Array;
}

/**
 * Header defines the parlia client consensus Header. It encapsulates all the
 * information necessary to update from a trusted parlia ConsensusState.
 */
export interface Header {
  /** opaque json bytes which must be unmarshalled into a valid signed EVM header */
  evmHeader: Uint8Array;
  /** trusted height that will be used to verify the `evm_header` */
...
function createBaseConsensusState(): ConsensusState {
  return { headers: new Uint8Array() };
}

export const ConsensusState = {
  encode(message: ConsensusState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.headers.length !== 0) {
      writer.uint32(10).bytes(message.headers);
    }
    return writer;
  },
  ...
  fromJSON(object: any): ConsensusState {
    return { headers: isSet(object.headers) ? bytesFromBase64(object.headers) : new Uint8Array() };
  },

  toJSON(message: ConsensusState): unknown {
    const obj: any = {};
    message.headers !== undefined &&
      (obj.headers = base64FromBytes(message.headers !== undefined ? message.headers : new Uint8Array()));
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<ConsensusState>, I>>(object: I): ConsensusState {
    const message = createBaseConsensusState();
    message.headers = object.headers ?? new Uint8Array();
    return message;
  },
};

function createBaseHeader(): Header {
  return { evmHeader: new Uint8Array(), trustedHeight: undefined };
}

export const Header = {
  encode(message: Header, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.evmHeader.length !== 0) {
      writer.uint32(10).bytes(message.evmHeader);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Header {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.evmHeader = reader.bytes();
          break;
        case 2:
  ...
  fromJSON(object: any): Header {
    return {
      evmHeader: isSet(object.evmHeader) ? bytesFromBase64(object.evmHeader) : new Uint8Array(),
  ...
  toJSON(message: Header): unknown {
    const obj: any = {};
    message.evmHeader !== undefined &&
      (obj.evmHeader = base64FromBytes(message.evmHeader !== undefined ? message.evmHeader : new Uint8Array()));
  ...
  fromPartial<I extends Exact<DeepPartial<Header>, I>>(object: I): Header {
    const message = createBaseHeader();
    message.evmHeader = object.evmHeader ?? new Uint8Array();
