...
import { PortInfo, Registry } from "./registry";
...
export interface GenesisState {
  ...
  portId: string;
  portInfoMap: { [key: string]: PortInfo };
  registryMap: { [key: string]: Registry };
  /** this line is used by starport scaffolding # genesis/proto/state */
  channelMap: { [key: string]: string };
}

export interface GenesisState_PortInfoMapEntry {
  key: string;
  value?: PortInfo;
}

export interface GenesisState_RegistryMapEntry {
  key: string;
  value?: Registry;
}
...
export const GenesisState = {
  encode(message: GenesisState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    Object.entries(message.portInfoMap).forEach(([key, value]) => {
      GenesisState_PortInfoMapEntry.encode({ key: key as any, value }, writer.uint32(58).fork()).ldelim();
    });
    Object.entries(message.registryMap).forEach(([key, value]) => {
      GenesisState_RegistryMapEntry.encode({ key: key as any, value }, writer.uint32(66).fork()).ldelim();
    });
    Object.entries(message.channelMap).forEach(([key, value]) => {
      GenesisState_ChannelMapEntry.encode({ key: key as any, value }, writer.uint32(74).fork()).ldelim();
    });
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          break;
        case 7:
          const entry7 = GenesisState_PortInfoMapEntry.decode(reader, reader.uint32());
          if (entry7.value !== undefined) {
            message.portInfoMap[entry7.key] = entry7.value;
          }
          break;
        case 8:
          const entry8 = GenesisState_RegistryMapEntry.decode(reader, reader.uint32());
          if (entry8.value !== undefined) {
            message.registryMap[entry8.key] = entry8.value;
          }
          break;
        case 9:
          const entry9 = GenesisState_ChannelMapEntry.decode(reader, reader.uint32());
          if (entry9.value !== undefined) {
            message.channelMap[entry9.key] = entry9.value;
          }
          break;
        default:
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      portInfoMap: isObject(object.portInfoMap)
        ? Object.entries(object.portInfoMap).reduce<{ [key: string]: PortInfo }>((acc, [key, value]) => {
          acc[key] = PortInfo.fromJSON(value);
          return acc;
        }, {})
        : {},
      registryMap: isObject(object.registryMap)
        ? Object.entries(object.registryMap).reduce<{ [key: string]: Registry }>((acc, [key, value]) => {
          acc[key] = Registry.fromJSON(value);
          return acc;
        }, {})
        : {},
  ...
  toJSON(message: GenesisState): unknown {
    ...
    obj.portInfoMap = {};
    if (message.portInfoMap) {
      Object.entries(message.portInfoMap).forEach(([k, v]) => {
        obj.portInfoMap[k] = PortInfo.toJSON(v);
      });
    }
    obj.registryMap = {};
    if (message.registryMap) {
      Object.entries(message.registryMap).forEach(([k, v]) => {
        obj.registryMap[k] = Registry.toJSON(v);
      });
    }
    obj.channelMap = {};
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(object: I): GenesisState {
    ...
    message.portInfoMap = Object.entries(object.portInfoMap ?? {}).reduce<{ [key: string]: PortInfo }>(
      (acc, [key, value]) => {
        if (value !== undefined) {
    ...
    message.registryMap = Object.entries(object.registryMap ?? {}).reduce<{ [key: string]: Registry }>(
      (acc, [key, value]) => {
        if (value !== undefined) {
          acc[key] = Registry.fromPartial(value);
        }
        return acc;
      },
      {},
...
function createBaseGenesisState_PortInfoMapEntry(): GenesisState_PortInfoMapEntry {
  return { key: "", value: undefined };
}

export const GenesisState_PortInfoMapEntry = {
  encode(message: GenesisState_PortInfoMapEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GenesisState_PortInfoMapEntry {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGenesisState_PortInfoMapEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): GenesisState_PortInfoMapEntry {
    return {
  ...
  toJSON(message: GenesisState_PortInfoMapEntry): unknown {
    const obj: any = {};
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState_PortInfoMapEntry>, I>>(
    object: I,
  ): GenesisState_PortInfoMapEntry {
    const message = createBaseGenesisState_PortInfoMapEntry();
...
function createBaseGenesisState_RegistryMapEntry(): GenesisState_RegistryMapEntry {
  return { key: "", value: undefined };
}

export const GenesisState_RegistryMapEntry = {
  encode(message: GenesisState_RegistryMapEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
      Registry.encode(message.value, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): GenesisState_RegistryMapEntry {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGenesisState_RegistryMapEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.value = Registry.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): GenesisState_RegistryMapEntry {
    return {
      key: isSet(object.key) ? String(object.key) : "",
      value: isSet(object.value) ? Registry.fromJSON(object.value) : undefined,
    };
  },

  toJSON(message: GenesisState_RegistryMapEntry): unknown {
    const obj: any = {};
    message.key !== undefined && (obj.key = message.key);
    message.value !== undefined && (obj.value = message.value ? Registry.toJSON(message.value) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<GenesisState_RegistryMapEntry>, I>>(
    object: I,
  ): GenesisState_RegistryMapEntry {
    const message = createBaseGenesisState_RegistryMapEntry();
    message.key = object.key ?? "";
    message.value = (object.value !== undefined && object.value !== null)
      ? Registry.fromPartial(object.value)
      : undefined;
    return message;
  },
};
